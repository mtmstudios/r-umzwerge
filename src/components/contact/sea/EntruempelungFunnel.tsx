...
import { X, Home, Building2, Warehouse, Car, Store, Phone, User, MapPin, Lock } from "lucide-react";
...
export function EntruempelungFunnel({ open, onOpenChange }: EntruempelungFunnelProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        quelle: 'entruempelung', funnel_typ: 'entruempelung-micro',
  ...
  const renderStep1 = () => (
    <div className="space-y-4">
      <div className="text-center mb-4">
        <h3 className="text-lg lg:text-2xl font-bold text-foreground mb-1">Wo benötigen Sie unsere Hilfe?</h3>
