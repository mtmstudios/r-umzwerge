      ...
      <div className="container-custom">
        <div className="grid grid-cols-3 lg:flex lg:justify-between items-center gap-6 lg:gap-8">
          ...
          <a href="/" className="flex items-center justify-center lg:justify-start group shrink-0 lg:-ml-12">
            <div className="h-28 lg:h-24 overflow-hidden flex items-center">
              <img 
                src={logoRaeumzwerge} 
                alt="Räumzwerge - Entrümpelungen, Auflösungen, Service" 
                className="h-96 lg:h-80 w-auto object-contain object-center lg:object-left transition-all duration-300 group-hover:scale-[1.03] group-hover:opacity-90"
              />
            </div>
          </a>
